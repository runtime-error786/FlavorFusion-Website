...
const Protect = ({ children }) => {
    ...
    if (role === "admin") {
        ...
        if ( router === "/admin" || router === "/admin/addadmin" || router === "/admin/addproduct" ||  router === "/error" || router === "/admin/deladmin" || router === "/admin/delprod" || router === "/admin/updateprod" || router === "/admin/dashboard") {
            return <>{children}</>;
        } else {
            route.push("/error");
            return null;
